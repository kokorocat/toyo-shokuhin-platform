  ...
  return (
    <div className="mx-auto min-h-screen max-w-2xl px-4 py-8">
      <div className="mb-10 text-center">
        <p className="text-base font-medium text-slate-500">{store.store_name}</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-900">
          衛生チェック入力
        </h1>
        <p className="mt-3 text-base text-slate-500">ログインは不要です。下記から選んでください。</p>
      </div>

      <div className="space-y-5">
        <Link
          href={`/haccp/kiosk/${token}/keypoint`}
          className="flex items-center gap-4 rounded-2xl border-2 border-slate-200 bg-white px-5 py-6 shadow-sm transition-all hover:border-blue-400 hover:shadow-md active:scale-[0.99] sm:px-6 sm:py-7"
        >
          ...
          <div>
            <p className="text-xl font-bold text-slate-900">重要ポイント・温度・ラベル</p>
            <p className="mt-1 text-base text-slate-500">本日の重要管理点・温度・ラベルを記録します</p>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div>
            <p className="text-xl font-bold text-slate-900">従業員衛生チェック</p>
            <p className="mt-1 text-base text-slate-500">出勤したご自身の体調・身だしなみを記録します</p>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div>
            <p className="text-xl font-bold text-slate-900">食品衛生自主点検（月次）</p>
            <p className="mt-1 text-base text-slate-500">今月の自主点検を記録します</p>
          </div>
        </Link>
      </div>
    </div>
