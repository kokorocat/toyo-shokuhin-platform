...
function StatusDot({ recorded }: { recorded: boolean }) {
  return (
    <span
      className={`inline-block h-2.5 w-2.5 rounded-full ring-2 ${recorded ? "bg-green-500 ring-green-200" : "bg-slate-300 ring-slate-100"}`}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-3 text-white shadow-md">
        <h1 className="text-lg font-bold">HACCP管理</h1>
      ...
      <div className="mx-auto max-w-2xl px-4 py-6 pb-10">
        ...
        <section className="mb-8 grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          >
            ...
            <p className="text-sm font-bold text-slate-800">重要ポイント・温度・ラベル</p>
          ...
          <Link
            href="/haccp/employee"
            className="group rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-green-300 hover:shadow-md"
          >
            <div className="mb-3 flex items-center justify-between">
            ...
            <p className="text-sm font-bold text-slate-800">従業員衛生</p>
            <p className="mt-1 text-xs text-slate-400">本日 {employeeTodayCount ?? 0} 名記録済み</p>
          </Link>
          <Link
            href="/haccp/inspection"
            className="group rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-amber-300 hover:shadow-md"
          >
            <div className="mb-3 flex items-center justify-between">
            ...
            <p className="text-sm font-bold text-slate-800">食品衛生自主点検</p>
            <p className="mt-1 text-xs text-slate-400">
              {inspectionThisMonth
        ...
        <section className="mb-8 grid grid-cols-2 gap-3">
          <Link
            href="/haccp/holiday"
            className="group flex items-center justify-center gap-2.5 rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-blue-300 hover:shadow-md"
          >
            <svg className="h-4 w-4 text-slate-400 transition-colors group-hover:text-blue-600" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
            </svg>
            <p className="text-sm font-semibold text-slate-700">店休日登録</p>
          </Link>
          <Link
            href="/haccp/history"
            className="group flex items-center justify-center gap-2.5 rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-blue-300 hover:shadow-md"
          >
            ...
            <p className="text-sm font-semibold text-slate-700">過去回答一覧</p>
          </Link>
        </section>
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-200 bg-blue-50 px-5 py-3">
            <h2 className="text-base font-bold text-blue-800">責任者確認（半月）</h2>
